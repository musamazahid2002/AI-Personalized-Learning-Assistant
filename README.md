...
<img src="<img width="1536" height="1024" alt="AI Personalized Learning Assistant" src="https://github.com/user-attachments/assets/fef5e2ba-b12e-409a-848b-5e0b03ea29e5" />
" width="70%" alt="Dashboard">
...
```bash
git clone https://github.com/your-username/AI-Personalized-Learning-Assistant.git
```

## 2. Navigate to the project

```bash
cd AI-Personalized-Learning-Assistant-main
```
...
```text
AI-Personalized-Learning-Assistant-main
│
├── app
│   ├── globals.css
│   ├── layout.js
...
│
├── public
│   └── ai-personalized-learning-assistant.png
│
├── package.json
├── next.config.js
├── tailwind.config.js
